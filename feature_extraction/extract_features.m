function feature_map = extract_features(image, pos, scales, features, gparams, extract_info, seq)
...
%==================================DUCF==========================================
if seq.frame == 1
for scale_ind = 1:num_sizes
    img_samples{scale_ind} = findForegroundVideo(img_samples{scale_ind},seq.init_sz);
end
end
%====================================================================================
